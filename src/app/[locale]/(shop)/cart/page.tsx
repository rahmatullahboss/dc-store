      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground">{t("itemsCount", { count: itemCount })}</p>
          </div>
        </div>
            ...
            <div className="bg-card rounded-2xl p-6 shadow-lg border border-border sticky top-4">
                ...
                <div className="mb-6 p-4 bg-primary/10 rounded-xl">
                  <p className="text-sm text-foreground mb-2">
                    {t.rich("summary.shippingMsg", {
                      amount: () => <span className="font-bold text-primary">{formatPrice(amountToFreeShipping)}</span>
                    })}
                  </p>
              ...
              <div className="mb-6">
                ...
                <div className="flex gap-2">
                  ...
                  <Button variant="outline">{t("summary.apply")}</Button>
                </div>
              </div>
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex justify-between text-muted-foreground">
                  ...
                  >
                    {shippingCost === 0 ? t("summary.free") : formatPrice(shippingCost)}
                  </span>
                </div>
