    ...
    if (paymentMethod === "stripe" && !clientSecret && items.length > 0) {
      ...
      fetch("/api/payments/create-intent", {
        ...
        .catch((err: Error) => {
          ...
          setStripeError(err.message || t("errors.paymentLoadFailed"));
          toast.error(err.message || t("errors.paymentLoadFailed"));
        })
        .finally(() => setStripeLoading(false));
    }
  }, [paymentMethod, clientSecret, total, items.length, t]);
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-center gap-4 mb-8">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-foreground hidden sm:block">{t("steps.cart")}</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-foreground hidden sm:block">{t("steps.shipping")}</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-muted-foreground hidden sm:block">{t("steps.done")}</span>
          </div>
        </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-card rounded-2xl p-6 shadow-lg border border-border">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-lg font-bold text-foreground">{t("shippingInfo")}</h2>
                </div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label htmlFor="division">{t("form.division")} *</Label>
                    <Select
                      value={formData.division}
                      onValueChange={(value) => handleInputChange("division", value)}
                    >
                      <SelectTrigger>
                        <SelectValue placeholder={t("form.placeholders.selectDivision")} />
                      </SelectTrigger>
                      <SelectContent>
                        {divisions.map((div) => (
                  ...
                  <div>
                    ...
                    >
                      <SelectTrigger>
                        <SelectValue placeholder={formData.division ? t("form.placeholders.selectDistrict") : t("form.placeholders.selectDivisionFirst")} />
                      </SelectTrigger>
                      <SelectContent>
                        {formData.division &&
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div className="flex-1 text-left">
                      <h3 className="font-bold text-foreground">{t("methods.cod.title")}</h3>
                      <p className="text-sm text-muted-foreground">{t("methods.cod.desc")}</p>
                    </div>
                    {paymentMethod === "cod" && (
                  ...
                  >
                    ...
                    <div className="flex-1 text-left">
                      <h3 className="font-bold text-foreground">{t("methods.stripe.title")}</h3>
                      <p className="text-sm text-muted-foreground">{t("methods.stripe.desc")}</p>
                    </div>
                    {paymentMethod === "stripe" && (
                      <div className="w-6 h-6 rounded-full bg-primary flex items-center justify-center">
                        <Check className="h-4 w-4 text-white" />
                      ...
                      {stripeLoading ? (
                        ...
                        <div className="text-center py-4 space-y-3">
                          <p className="text-red-600">
                            {stripeError || t("errors.paymentLoadFailed")}
                          </p>
                          <Button
                            type="button"
                            variant="outline"
